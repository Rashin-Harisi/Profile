    ...
    <div className="py-20 " id='projects'>
        ...
        <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10">
            {projects.map(({id, title,des, img, iconLists,link})=>(
                <div key={id} className="lg:min-h-[32.5rem] mb-7 h-[25rem]
                flex items-center justify-center sm:w-[570px] w-[80vw]" >
                    <PinContainer title={link} href={link}>
                        ...
                        overflow-hidden  h-[30vh] sm:h-[40vh] mb-10">
                            <img src={img} alt={title} className="z-10 w-full h-full absolute  lg:rounded-3xl bottom-0"/>
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-7 mb-3">
                            ...
                            <div className="flex justify-center items-center">
                                ...
                                <FaLocationArrow className="ms-3" color="#CBACB9"/>
                            </div>
                        </div>
                    </PinContainer>
                </div>
